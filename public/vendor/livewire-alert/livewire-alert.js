    ...
    var __webpack_modules__ = {
        757: (e, t, r) => {
            ...
            var t = function (e) {
                ...
                function l(e, t, r, n) {
                    var o = t && t.prototype instanceof y ? t : y, i = Object.create(o.prototype), a = new x(n || []);
                ...
                e.wrap = l;
                var f = "suspendedStart", p = "suspendedYield", _ = "executing", d = "completed", h = {};
                ...
                var w = Object.getPrototypeOf, g = w && w(w(D([])));
                    ...
                    for (; ;) switch (e.prev = e.next) {
                        ...
                        case 8:
                            afterAlertInteraction(_objectSpread(_objectSpread(_objectSpread({
                                ...
                                denied: l.isDenied,
                                dismiss: l.dismiss,
                                result: _objectSpread(_objectSpread({}, l), {}, {data: _objectSpread(_objectSpread({}, a), {}, {inputAttributes: null !== (n = s.inputAttributes) && void 0 !== n ? n : null})})
                            }, c), l), s));
                        case 10:
                        case"end":
                            return e.stop()
                    ...
                    for (; ;) switch (e.prev = e.next) {
                        ...
                        case 6:
                            afterAlertInteraction(_objectSpread(_objectSpread({
                                ...
                                denied: s.isDenied,
                                dismiss: s.dismiss,
                                result: _objectSpread(_objectSpread({}, s), {}, {data: _objectSpread(_objectSpread({}, a), {}, {inputAttributes: null !== (o = c.inputAttributes) && void 0 !== o ? o : null})})
                            }, i), t.options));
                        case 8:
                        case"end":
                            return e.stop()
...
function evalCallbacksOptions(options) {
    ...
    // Add line breaks to message.detail
    if (options.hasOwnProperty('message') && options.message.hasOwnProperty('detail')) {
        options.message.detail = options.message.detail.replace(/\n/g, '<br>');
    }
}
