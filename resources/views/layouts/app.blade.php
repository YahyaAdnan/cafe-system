...
<style>
    ...
    @keyframes animatedBackground-2 {
        0% {
            background-color: rgba(80, 227, 194, 0.35);
        }
        25% {
            background-color: rgba(227, 80, 194, 0.35);
        }
        50% {
            background-color: rgba(194, 227, 80, 0.35);
        }
        75% {
            background-color: rgba(194, 80, 227, 0.35);
        }
        100% {
            background-color: rgba(80, 194, 227, 0.35);
        }
    }
    ...
    @keyframes boxShadowAnimation {
        ...
        25% {
            box-shadow: 0 8px 32px 0 rgba(135, 31, 38, 0.37);
        }
        50% {
            box-shadow: 0 8px 32px 0 rgba(38, 135, 31, 0.37);
        }
        75% {
            box-shadow: 0 8px 32px 0 rgba(31, 194, 38, 0.37);
        }
        100% {
            box-shadow: 0 8px 32px 0 rgba(38, 31, 135, 0.37);
        }
    }

    .animated-container {
        animation: animatedBackground-2 10s ease-in-out infinite,
        boxShadowAnimation 10s ease-in-out infinite;
        padding: 5px;
    }

    .animated-container .card-scroll {
        flex: 0 0 auto;
    ...
    ::-webkit-scrollbar-thumb:hover {
        background-color: rgba(0, 0, 0, 0.7); /* Set the color of the scrollbar thumb on hover */
    }
...
<div class="h-20 fixed shadow-2xl w-full z-50" style="
